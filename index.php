...
// }
// echo '$response_data : ' . var_dump($response_data) . '<br>';

// All user data exists in 'data' object
$user_data = $response_data->data;


//echo '$user_data:' . var_dump($user_data) . '<br>';
...
<body>
	<div class="container">
		...
		<div align="right" style="margin-bottom:5px;">
			...
			<a name="add_button" id="add_button" class="btn btn-md btn-success" style="margin-bottom: 10px">TAMBAH DATA
				MODAL</a>
		</div>
